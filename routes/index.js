...
router
    ...
    .post('/upload-image', (req, res, next) => {
        let photoPerfil;
        let uploadPath;
    ...
    .post('/edit-profile-user', (req, res, next) => {
        req.getConnection((err, conn) => {
            let user = {
                first_name: req.body.firstName_txt,
                last_name: req.body.lastName_txt,
    ...
    .get('/home/edit-user/:id', (req, res, next) => {
        if(req.session.user && req.session.user[0].rol == 0){
            req.getConnection((err, conn) => {
    ...
    .get('/home/delete-user/:id', (req, res, next) => {
        if(req.session.user.length && req.session.user[0].rol == 0){
            req.getConnection((err, conn) => {
                let id = req.params.id;
    ...
    .post('/update-permissions-user', (req, res, next) => {
        if(req.session.user.length && req.session.user[0].rol == 0){
            req.getConnection((err, conn) => {
                let u = {
                    id: req.body.id_user,
